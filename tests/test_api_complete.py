...
def test_get_recent_trades(client: TestClient):
    ...
    trades_data = [
        {"symbol": "BTC-PERP", "side": "long", "size": "0.1", "price": "45000.00", "leverage": 10},
        {"symbol": "ETH-PERP", "side": "short", "size": "1.0", "price": "3000.00", "leverage": 5},
        {"symbol": "SOL-PERP", "side": "long", "size": "10.0", "price": "100.00", "leverage": 3}
    ]
